...
var Query = {
  getNewsEvents: function getNewsEvents(_, _ref) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee() {
      var search, type, category, dateFrom, dateTo, from, to, exceptId, searchQuery, rangeDates, query, newsEvents, quantity;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              search = _ref.search, type = _ref.type, category = _ref.category, dateFrom = _ref.dateFrom, dateTo = _ref.dateTo, from = _ref.from, to = _ref.to, exceptId = _ref.exceptId;
              _context.prev = 1;
              searchQuery = search && {
                $text: {
                  $search: search
  ...
  getNewsEvent: function getNewsEvent(_, _ref2) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
      var contentId, type, newsEvent;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              contentId = _ref2.contentId, type = _ref2.type;
              _context2.prev = 1;
              _context2.next = 4;
...
var Mutation = {
  createNewsEvent: function createNewsEvent(_, _ref3, _ref4) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3() {
      var title, content, type, category, dateEvent, links, isAuth, _yield$createEditVali, vTitle, vContent, vDateEvent, isError, newsEvent, newNewsEvent, i, extraLink;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              title = _ref3.title, content = _ref3.content, type = _ref3.type, category = _ref3.category, dateEvent = _ref3.dateEvent, links = _ref3.links;
              isAuth = _ref4.isAuth;
              _context3.prev = 2;
  ...
  editNewsEvent: function editNewsEvent(_, _ref5, _ref6) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee4() {
      var contentId, title, content, type, category, dateEvent, links, isAuth, _yield$createEditVali2, vTitle, vContent, vDateEvent, isError, i, extraLink;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              contentId = _ref5.contentId, title = _ref5.title, content = _ref5.content, type = _ref5.type, category = _ref5.category, dateEvent = _ref5.dateEvent, links = _ref5.links;
              isAuth = _ref6.isAuth;
              _context4.prev = 2;
...
var Query = {
  ...
  getPageSections: function getPageSections(_, _ref2) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee2() {
      var search, url, filters, from, to, exceptId, searchQuery, collection, quantity, _loop, i, collectionNew, sections, _sections;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee2$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              search = _ref2.search, url = _ref2.url, filters = _ref2.filters, from = _ref2.from, to = _ref2.to, exceptId = _ref2.exceptId;
              _context3.prev = 1;
              searchQuery = search && {
                $text: {
                  $search: search
  ...
  searchContent: function searchContent(_, _ref3) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee3() {
      var search, tags, searchQuery, keyWords, collection, uploads, news, events, sections, pagesection;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee3$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              search = _ref3.search, tags = _ref3.tags;
              _context4.prev = 1;
              searchQuery = search && {
                $text: {
                  $search: search
            ...
            case 20:
              ...
              pagesection = _models__WEBPACK_IMPORTED_MODULE_3__.PageSection.find(_objectSpread({}, searchQuery)).sort({
                date: -1
              });
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              _context5.prev = 1;
              _context5.next = 4;
              return _models__WEBPACK_IMPORTED_MODULE_3__.PageSection.findById(sectionId).populate({
                path: "filters"
              });
...
var Mutation = {
  createPageSection: function createPageSection(_, _ref5, _ref6) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee5() {
      var title, content, priority, url, filters, optContent, isAuth, _yield$createEditVali, vTitle, vContent, vPriority, vUrl, isError, errors, i, page, savedPage, newPage, pageCollection, newSection, section, _i2, filter, newFilter;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee5$(_context6) {
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              title = _ref5.title, content = _ref5.content, priority = _ref5.priority, url = _ref5.url, filters = _ref5.filters, optContent = _ref5.optContent;
              isAuth = _ref6.isAuth;
              _context6.prev = 2;
  ...
  editPageSection: function editPageSection(_, _ref7, _ref8) {
    return _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().mark(function _callee6() {
      var sectionId, title, content, priority, filters, optContent, isAuth, _yield$createEditVali2, vTitle, vContent, vPriority, isError, errors, i, _i3;

      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_2___default().wrap(function _callee6$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              sectionId = _ref7.sectionId, title = _ref7.title, content = _ref7.content, priority = _ref7.priority, filters = _ref7.filters, optContent = _ref7.optContent;
              isAuth = _ref8.isAuth;
              _context7.prev = 2;
